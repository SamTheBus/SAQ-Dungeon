    ...
    const newArtifacts = [
      {
        ...
        breakdown:
          "<strong>Vanguard Burst:</strong><br>• Initial Speed: <span style='color:#3498db;'>+40% Move Speed</span><br>• Initial Crit: <span style='color:#f1c40f;'>+25% Crit Chance</span><br>• Decay Limit: <span style='color:#aaa;'>Linearly decays to zero over 30 seconds</span><br>• Passive: <span style='color:#2ecc71;'>+2% Base Crit Chance</span>",
        tier: 3,
        critChance: 0.02,
        dropRate: 0,
        quality: 0,
      ...
      },
      {
        ...
        breakdown:
          "<strong>Breach Barrier:</strong><br>• Initial Shield: <span style='color:#34d399;'>100% Max HP Overshield</span><br>• Decay Limit: <span style='color:#aaa;'>Decays by 5% Max HP per second (depleted in 20s)</span><br>• Passive: <span style='color:#3498db;'>+5 Flat Defense</span>",
        tier: 3,
        def: 5,
        dropRate: 0,
        quality: 0,
      ...
      },
      {
        ...
        breakdown:
          "<strong>Time Accretion:</strong><br>• Level Scaler: <span style='color:#9b59b6;'>+3% Damage every 10s spent on active floor</span><br>• Stage Limit: <span style='color:#aaa;'>Capped at +30% Damage (100 seconds)</span><br>• Passive: <span style='color:#df9ffb;'>+5% Drop Quality</span>",
        tier: 2,
        quality: 0.05,
        dropRate: 0,
        goldMulti: 0,
