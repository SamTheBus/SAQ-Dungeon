...
window.AchievementsData = [
  ...
  { id: "slayer_1", name: "Slayer I", icon: "slayer", desc: "Slay 50 total dungeon monsters", reqType: "kills", reqValue: 50, stats: { atk: 2, atkPct: 0.01 } },
  { id: "slayer_2", name: "Slayer II", icon: "slayer", desc: "Slay 250 total dungeon monsters", reqType: "kills", reqValue: 250, stats: { atk: 5, atkPct: 0.02 } },
  { id: "slayer_3", name: "Slayer III", icon: "slayer", desc: "Slay 1,000 total dungeon monsters", reqType: "kills", reqValue: 1000, stats: { atk: 10, atkPct: 0.03 } },
  { id: "slayer_4", name: "Slayer IV", icon: "slayer", desc: "Slay 5,000 total dungeon monsters", reqType: "kills", reqValue: 5000, stats: { atk: 25, atkPct: 0.04 } },
  { id: "slayer_5", name: "Slayer V", icon: "slayer", desc: "Slay 20,000 total dungeon monsters", reqType: "kills", reqValue: 20000, stats: { atk: 50, atkPct: 0.05 } },
  { id: "slayer_6", name: "Slayer VI", icon: "slayer", desc: "Slay 50,000 total dungeon monsters", reqType: "kills", reqValue: 50000, stats: { atk: 100, atkPct: 0.06 } },
  { id: "slayer_7", name: "Slayer VII", icon: "slayer", desc: "Slay 150,000 total dungeon monsters", reqType: "kills", reqValue: 150000, stats: { atk: 250, atkPct: 0.08 } },
  { id: "slayer_8", name: "Slayer VIII", icon: "slayer", desc: "Slay 500,000 total dungeon monsters", reqType: "kills", reqValue: 500000, stats: { atk: 500, atkPct: 0.12 } },

  // 2. FLOOR EXPLORERS (Dungeon Depth)
  { id: "floor_1", name: "Explorer I", icon: "stage", desc: "Clear Dungeon Floor 5", reqType: "floor", reqValue: 5, stats: { def: 1, defPct: 0.01 } },
  { id: "floor_2", name: "Explorer II", icon: "stage", desc: "Clear Dungeon Floor 12 (Sector 1 Boss)", reqType: "floor", reqValue: 12, stats: { def: 3, defPct: 0.02 } },
  { id: "floor_3", name: "Explorer III", icon: "stage", desc: "Clear Dungeon Floor 24 (Sector 2 Boss)", reqType: "floor", reqValue: 24, stats: { def: 8, defPct: 0.03 } },
  { id: "floor_4", name: "Explorer IV", icon: "stage", desc: "Clear Dungeon Floor 36 (Sector 3 Boss)", reqType: "floor", reqValue: 36, stats: { def: 15, defPct: 0.04 } },
  { id: "floor_5", name: "Explorer V", icon: "stage", desc: "Clear Dungeon Floor 48 (Sector 4 Boss)", reqType: "floor", reqValue: 48, stats: { def: 30, defPct: 0.05 } },
  { id: "floor_6", name: "Explorer VI", icon: "stage", desc: "Clear Dungeon Floor 72 (Sector 6 Boss)", reqType: "floor", reqValue: 72, stats: { def: 60, defPct: 0.07 } },
  { id: "floor_7", name: "Explorer VII", icon: "stage", desc: "Clear Dungeon Floor 100", reqType: "floor", reqValue: 100, stats: { def: 120, defPct: 0.10 } },
  { id: "floor_8", name: "Explorer VIII", icon: "stage", desc: "Clear Dungeon Floor 150", reqType: "floor", reqValue: 150, stats: { def: 250, defPct: 0.15 } },

  // 3. WEALTH & TREASURY (Total Gold Earned)
  { id: "hoarder_1", name: "Hoarder I", icon: "hoarder", desc: "Earn 10,000 total Gold", reqType: "gold", reqValue: 10000, stats: { gold: 0.01, maxHp: 10 } },
  { id: "hoarder_2", name: "Hoarder II", icon: "hoarder", desc: "Earn 100,000 total Gold", reqType: "gold", reqValue: 100000, stats: { gold: 0.02, maxHp: 25 } },
  { id: "hoarder_3", name: "Hoarder III", icon: "hoarder", desc: "Earn 1,000,000 total Gold", reqType: "gold", reqValue: 1000000, stats: { gold: 0.03, maxHp: 60 } },
  { id: "hoarder_4", name: "Hoarder IV", icon: "hoarder", desc: "Earn 10,000,000 total Gold", reqType: "gold", reqValue: 10000000, stats: { gold: 0.04, maxHp: 150 } },
  { id: "hoarder_5", name: "Hoarder V", icon: "hoarder", desc: "Earn 100,000,000 total Gold", reqType: "gold", reqValue: 100000000, stats: { gold: 0.05, maxHp: 400 } },
  { id: "hoarder_6", name: "Hoarder VI", icon: "hoarder", desc: "Earn 1,000,000,000 total Gold", reqType: "gold", reqValue: 1000000000, stats: { gold: 0.07, maxHp: 1000 } },
  { id: "hoarder_7", name: "Hoarder VII", icon: "hoarder", desc: "Earn 10,000,000,000 total Gold", reqType: "gold", reqValue: 10000000000, stats: { gold: 0.10, maxHp: 2500 } },
  { id: "hoarder_8", name: "Hoarder VIII", icon: "hoarder", desc: "Earn 100,000,000,000 total Gold", reqType: "gold", reqValue: 100000000000, stats: { gold: 0.15, maxHp: 6000 } },

  // 4. EXTRACTION SURVIVORS (Successful Extractions)
  { id: "extract_1", name: "Survivor I", icon: "d_go", desc: "Complete 1 successful Extraction", reqType: "extract", reqValue: 1, stats: { maxHpPct: 0.01, expPct: 0.02 } },
  { id: "extract_2", name: "Survivor II", icon: "d_go", desc: "Complete 5 successful Extractions", reqType: "extract", reqValue: 5, stats: { maxHpPct: 0.02, expPct: 0.03 } },
  { id: "extract_3", name: "Survivor III", icon: "d_go", desc: "Complete 15 successful Extractions", reqType: "extract", reqValue: 15, stats: { maxHpPct: 0.03, expPct: 0.04 } },
  { id: "extract_4", name: "Survivor IV", icon: "d_go", desc: "Complete 40 successful Extractions", reqType: "extract", reqValue: 40, stats: { maxHpPct: 0.04, expPct: 0.05 } },
  { id: "extract_5", name: "Survivor V", icon: "d_go", desc: "Complete 100 successful Extractions", reqType: "extract", reqValue: 100, stats: { maxHpPct: 0.05, expPct: 0.07 } },
  { id: "extract_6", name: "Survivor VI", icon: "d_go", desc: "Complete 250 successful Extractions", reqType: "extract", reqValue: 250, stats: { maxHpPct: 0.07, expPct: 0.10 } },
  { id: "extract_7", name: "Survivor VII", icon: "d_go", desc: "Complete 500 successful Extractions", reqType: "extract", reqValue: 500, stats: { maxHpPct: 0.10, expPct: 0.12 } },
  { id: "extract_8", name: "Survivor VIII", icon: "d_go", desc: "Complete 1,000 successful Extractions", reqType: "extract", reqValue: 1000, stats: { maxHpPct: 0.15, expPct: 0.15 } },

  // 5. SCRAP COLLECTORS (Salvaging)
  { id: "salvage_1", name: "Collector I", icon: "salvage", desc: "Salvage 10 items", reqType: "salvage", reqValue: 10, stats: { drop: 0.01, qly: 0.01 } },
  { id: "salvage_2", name: "Collector II", icon: "salvage", desc: "Salvage 50 items", reqType: "salvage", reqValue: 50, stats: { drop: 0.02, qly: 0.02 } },
  { id: "salvage_3", name: "Collector III", icon: "salvage", desc: "Salvage 200 items", reqType: "salvage", reqValue: 200, stats: { drop: 0.03, qly: 0.03 } },
  { id: "salvage_4", name: "Collector IV", icon: "salvage", desc: "Salvage 750 items", reqType: "salvage", reqValue: 750, stats: { drop: 0.04, qly: 0.04 } },
  { id: "salvage_5", name: "Collector V", icon: "salvage", desc: "Salvage 2,500 items", reqType: "salvage", reqValue: 2500, stats: { drop: 0.05, qly: 0.05 } },
  { id: "salvage_6", name: "Collector VI", icon: "salvage", desc: "Salvage 7,500 items", reqType: "salvage", reqValue: 7500, stats: { drop: 0.07, qly: 0.07 } },
  { id: "salvage_7", name: "Collector VII", icon: "salvage", desc: "Salvage 20,000 items", reqType: "salvage", reqValue: 20000, stats: { drop: 0.10, qly: 0.10 } },
  { id: "salvage_8", name: "Collector VIII", icon: "salvage", desc: "Salvage 50,000 items", reqType: "salvage", reqValue: 50000, stats: { drop: 0.15, qly: 0.15 } },

  // 6. ATTUNEMENT MASTERS (Slot Tempering)
  { id: "forge_1", name: "Blacksmith I", icon: "forge", desc: "Attune equipment slots 5 times", reqType: "temper", reqValue: 5, stats: { str: 1, strPct: 0.01 } },
  { id: "forge_2", name: "Blacksmith II", icon: "forge", desc: "Attune equipment slots 25 times", reqType: "temper", reqValue: 25, stats: { str: 3, strPct: 0.02 } },
  { id: "forge_3", name: "Blacksmith III", icon: "forge", desc: "Attune equipment slots 100 times", reqType: "temper", reqValue: 100, stats: { str: 8, strPct: 0.03 } },
  { id: "forge_4", name: "Blacksmith IV", icon: "forge", desc: "Attune equipment slots 250 times", reqType: "temper", reqValue: 250, stats: { str: 18, strPct: 0.04 } },
  { id: "forge_5", name: "Blacksmith V", icon: "forge", desc: "Attune equipment slots 500 times", reqType: "temper", reqValue: 500, stats: { str: 40, strPct: 0.05 } },
  { id: "forge_6", name: "Blacksmith VI", icon: "forge", desc: "Attune equipment slots 1,000 times", reqType: "temper", reqValue: 1000, stats: { str: 80, strPct: 0.07 } },
  { id: "forge_7", name: "Blacksmith VII", icon: "forge", desc: "Attune equipment slots 2,500 times", reqType: "temper", reqValue: 2500, stats: { str: 160, strPct: 0.10 } },
  { id: "forge_8", name: "Blacksmith VIII", icon: "forge", desc: "Attune equipment slots 5,000 times", reqType: "temper", reqValue: 5000, stats: { str: 350, strPct: 0.15 } },

  // 7. REFORGERS (Modifier Re-rolls)
  { id: "refo_1", name: "Reforger I", icon: "refo", desc: "Reforge gear modifiers 5 times", reqType: "reforges", reqValue: 5, stats: { dex: 1, dexPct: 0.01 } },
  { id: "refo_2", name: "Reforger II", icon: "refo", desc: "Reforge gear modifiers 20 times", reqType: "reforges", reqValue: 20, stats: { dex: 3, dexPct: 0.02 } },
  { id: "refo_3", name: "Reforger III", icon: "refo", desc: "Reforge gear modifiers 50 times", reqType: "reforges", reqValue: 50, stats: { dex: 8, dexPct: 0.03 } },
  { id: "refo_4", name: "Reforger IV", icon: "refo", desc: "Reforge gear modifiers 150 times", reqType: "reforges", reqValue: 150, stats: { dex: 18, dexPct: 0.04 } },
  { id: "refo_5", name: "Reforger V", icon: "refo", desc: "Reforge gear modifiers 300 times", reqType: "reforges", reqValue: 300, stats: { dex: 40, dexPct: 0.05 } },
  { id: "refo_6", name: "Reforger VI", icon: "refo", desc: "Reforge gear modifiers 600 times", reqType: "reforges", reqValue: 600, stats: { dex: 80, dexPct: 0.07 } },
  { id: "refo_7", name: "Reforger VII", icon: "refo", desc: "Reforge gear modifiers 1,200 times", reqType: "reforges", reqValue: 1200, stats: { dex: 160, dexPct: 0.10 } },
  { id: "refo_8", name: "Reforger VIII", icon: "refo", desc: "Reforge gear modifiers 2,500 times", reqType: "reforges", reqValue: 2500, stats: { dex: 350, dexPct: 0.15 } },

  // 8. RUNIC SCRIBES (Celestial Enchantments)
  { id: "enchant_1", name: "Scribe I", icon: "enchant", desc: "Infuse 1 Celestial Enchantment", reqType: "enchant", reqValue: 1, stats: { int: 1, intPct: 0.01 } },
  { id: "enchant_2", name: "Scribe II", icon: "enchant", desc: "Infuse 5 Celestial Enchantments", reqType: "enchant", reqValue: 5, stats: { int: 3, intPct: 0.02 } },
  { id: "enchant_3", name: "Scribe III", icon: "enchant", desc: "Infuse 20 Celestial Enchantments", reqType: "enchant", reqValue: 20, stats: { int: 8, intPct: 0.03 } },
  { id: "enchant_4", name: "Scribe IV", icon: "enchant", desc: "Infuse 50 Celestial Enchantments", reqType: "enchant", reqValue: 50, stats: { int: 18, intPct: 0.04 } },
  { id: "enchant_5", name: "Scribe V", icon: "enchant", desc: "Infuse 150 Celestial Enchantments", reqType: "enchant", reqValue: 150, stats: { int: 40, intPct: 0.05 } },
  { id: "enchant_6", name: "Scribe VI", icon: "enchant", desc: "Infuse 350 Celestial Enchantments", reqType: "enchant", reqValue: 350, stats: { int: 80, intPct: 0.07 } },
  { id: "enchant_7", name: "Scribe VII", icon: "enchant", desc: "Infuse 800 Celestial Enchantments", reqType: "enchant", reqValue: 800, stats: { int: 160, intPct: 0.10 } },
  { id: "enchant_8", name: "Scribe VIII", icon: "enchant", desc: "Infuse 2,000 Celestial Enchantments", reqType: "enchant", reqValue: 2000, stats: { int: 350, intPct: 0.15 } },

  // 9. DEFENSIVE AEGIS (Blocks & Parries)
  { id: "defl_1", name: "Unbreakable Aegis I", icon: "defl", desc: "Deflect (Block or Parry) 25 attacks", reqType: "deflections", reqValue: 25, stats: { def: 2, defPct: 0.01 } },
  { id: "defl_2", name: "Unbreakable Aegis II", icon: "defl", desc: "Deflect (Block or Parry) 100 attacks", reqType: "deflections", reqValue: 100, stats: { def: 5, defPct: 0.02 } },
  { id: "defl_3", name: "Unbreakable Aegis III", icon: "defl", desc: "Deflect (Block or Parry) 500 attacks", reqType: "deflections", reqValue: 500, stats: { def: 12, defPct: 0.03 } },
  { id: "defl_4", name: "Unbreakable Aegis IV", icon: "defl", desc: "Deflect (Block or Parry) 2,000 attacks", reqType: "deflections", reqValue: 2000, stats: { def: 25, defPct: 0.04 } },
  { id: "defl_5", name: "Unbreakable Aegis V", icon: "defl", desc: "Deflect (Block or Parry) 7,500 attacks", reqType: "deflections", reqValue: 7500, stats: { def: 60, defPct: 0.05 } },
  { id: "defl_6", name: "Unbreakable Aegis VI", icon: "defl", desc: "Deflect (Block or Parry) 20,000 attacks", reqType: "deflections", reqValue: 20000, stats: { def: 120, defPct: 0.07 } },
  { id: "defl_7", name: "Unbreakable Aegis VII", icon: "defl", desc: "Deflect (Block or Parry) 50,000 attacks", reqType: "deflections", reqValue: 50000, stats: { def: 250, defPct: 0.10 } },
  { id: "defl_8", name: "Unbreakable Aegis VIII", icon: "defl", desc: "Deflect (Block or Parry) 100,000 attacks", reqType: "deflections", reqValue: 100000, stats: { def: 500, defPct: 0.15 } },

  // 10. RARE HUNTERS (Elites & Rare Spawns Slain)
  { id: "rare_s_1", name: "Rare Hunter I", icon: "rare_s", desc: "Slay 5 Rare or Elite monsters", reqType: "rare_spawns", reqValue: 5, stats: { rareSpawn: 0.001, qly: 0.01 } },
  { id: "rare_s_2", name: "Rare Hunter II", icon: "rare_s", desc: "Slay 25 Rare or Elite monsters", reqType: "rare_spawns", reqValue: 25, stats: { rareSpawn: 0.002, qly: 0.02 } },
  { id: "rare_s_3", name: "Rare Hunter III", icon: "rare_s", desc: "Slay 100 Rare or Elite monsters", reqType: "rare_spawns", reqValue: 100, stats: { rareSpawn: 0.003, qly: 0.03 } },
  { id: "rare_s_4", name: "Rare Hunter IV", icon: "rare_s", desc: "Slay 350 Rare or Elite monsters", reqType: "rare_spawns", reqValue: 350, stats: { rareSpawn: 0.004, qly: 0.04 } },
  { id: "rare_s_5", name: "Rare Hunter V", icon: "rare_s", desc: "Slay 1,000 Rare or Elite monsters", reqType: "rare_spawns", reqValue: 1000, stats: { rareSpawn: 0.005, qly: 0.05 } },
  { id: "rare_s_6", name: "Rare Hunter VI", icon: "rare_s", desc: "Slay 2,500 Rare or Elite monsters", reqType: "rare_spawns", reqValue: 2500, stats: { rareSpawn: 0.007, qly: 0.07 } },
  { id: "rare_s_7", name: "Rare Hunter VII", icon: "rare_s", desc: "Slay 7,500 Rare or Elite monsters", reqType: "rare_spawns", reqValue: 7500, stats: { rareSpawn: 0.010, qly: 0.10 } },
  { id: "rare_s_8", name: "Rare Hunter VIII", icon: "rare_s", desc: "Slay 20,000 Rare or Elite monsters", reqType: "rare_spawns", reqValue: 20000, stats: { rareSpawn: 0.015, qly: 0.15 } },

  // 11. COLOSSUS STRIKE (Single Hit Record)
  { id: "hit_1", name: "Colossus Strike I", icon: "hit", desc: "Deal 250 single hit damage", reqType: "single_hit", reqValue: 250, stats: { critChance: 0.002, critDamage: 0.01 } },
  { id: "hit_2", name: "Colossus Strike II", icon: "hit", desc: "Deal 2,500 single hit damage", reqType: "single_hit", reqValue: 2500, stats: { critChance: 0.004, critDamage: 0.02 } },
  { id: "hit_3", name: "Colossus Strike III", icon: "hit", desc: "Deal 25,000 single hit damage", reqType: "single_hit", reqValue: 25000, stats: { critChance: 0.006, critDamage: 0.03 } },
  { id: "hit_4", name: "Colossus Strike IV", icon: "hit", desc: "Deal 250,000 single hit damage", reqType: "single_hit", reqValue: 250000, stats: { critChance: 0.008, critDamage: 0.04 } },
  { id: "hit_5", name: "Colossus Strike V", icon: "hit", desc: "Deal 2,500,000 single hit damage", reqType: "single_hit", reqValue: 2500000, stats: { critChance: 0.010, critDamage: 0.05 } },
  { id: "hit_6", name: "Colossus Strike VI", icon: "hit", desc: "Deal 25,000,000 single hit damage", reqType: "single_hit", reqValue: 25000000, stats: { critChance: 0.015, critDamage: 0.07 } },
  { id: "hit_7", name: "Colossus Strike VII", icon: "hit", desc: "Deal 250,000,000 single hit damage", reqType: "single_hit", reqValue: 250000000, stats: { critChance: 0.020, critDamage: 0.10 } },
  { id: "hit_8", name: "Colossus Strike VIII", icon: "hit", desc: "Deal 2,500,000,000 single hit damage", reqType: "single_hit", reqValue: 2500000000, stats: { critChance: 0.030, critDamage: 0.15 } },

  // 12. INVESTORS (Combined Gold Upgrades)
  { id: "g_up_1", name: "Investor I", icon: "g_up", desc: "Combined Gold Upgrade level 5", reqType: "gold_upgrades", reqValue: 5, stats: { gold: 0.01, int: 1 } },
  { id: "g_up_2", name: "Investor II", icon: "g_up", desc: "Combined Gold Upgrade level 15", reqType: "gold_upgrades", reqValue: 15, stats: { gold: 0.02, int: 3 } },
  { id: "g_up_3", name: "Investor III", icon: "g_up", desc: "Combined Gold Upgrade level 30", reqType: "gold_upgrades", reqValue: 30, stats: { gold: 0.03, int: 8 } },
  { id: "g_up_4", name: "Investor IV", icon: "g_up", desc: "Combined Gold Upgrade level 60", reqType: "gold_upgrades", reqValue: 60, stats: { gold: 0.04, int: 18 } },
  { id: "g_up_5", name: "Investor V", icon: "g_up", desc: "Combined Gold Upgrade level 100", reqType: "gold_upgrades", reqValue: 100, stats: { gold: 0.05, int: 40 } },
  { id: "g_up_6", name: "Investor VI", icon: "g_up", desc: "Combined Gold Upgrade level 150", reqType: "gold_upgrades", reqValue: 150, stats: { gold: 0.07, int: 80 } },
  { id: "g_up_7", name: "Investor VII", icon: "g_up", desc: "Combined Gold Upgrade level 220", reqType: "gold_upgrades", reqValue: 220, stats: { gold: 0.10, int: 160 } },
  { id: "g_up_8", name: "Investor VIII", icon: "g_up", desc: "Combined Gold Upgrade level 300", reqType: "gold_upgrades", reqValue: 300, stats: { gold: 0.15, int: 350 } },
  ...
  },
  {
    ...
    isSingleTier: true,
    stats: { gold: 0.15, goldMulti: 0.10 },
  },
  {
    id: "sing_full_bag",
    name: "Heavy Haul",
  ...
  },
  {
    ...
    isSingleTier: true,
    stats: { gold: 0.10, goldMulti: 0.05 },
  },
  {
    id: "sing_night_owl",
    name: "Night Owl",
